...
<head>
  ...
  <style>
    :root { --bg: #3E2723; --fg: #D7CCC8; }
    body {
      margin: 0; 
      font-family: Arial, sans-serif;
      background: var(--bg);
      background-image: url('../image/hogwarts.jpeg');
...
<body>
  <div class="house-banner">
    <h2>You are in <?php echo htmlspecialchars($house); ?>!</h2>
  </div>
  ...
  <div class="card" style="text-align:center;">
    <?php if ($uploadMessage !== ''): ?>
      <div style="margin-bottom:10px;color:#FFD700;"><?php echo $uploadMessage; ?></div>
    <?php endif; ?>
